...
func _ready():
	...
	var leg1Base = get_parent().get_node("Spider_LegG1").get_node("Base")
	#prints("leg1Base: ")
	#aprints(leg1Base)
	var leg2Base = get_parent().get_node("Spider_LegG2").get_node("Base")
	var leg3Base = get_parent().get_node("Spider_LegG3").get_node("Base")
	var leg4Base = get_parent().get_node("Spider_LegG4").get_node("Base")
