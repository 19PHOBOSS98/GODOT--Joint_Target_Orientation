...
func _ready():
	...
	var leg1Base = get_parent().get_node("Spider_LegF1").get_node("Base")
	#prints("leg1Base: ")
	#aprints(leg1Base)
	var leg2Base = get_parent().get_node("Spider_LegF2").get_node("Base")
	var leg3Base = get_parent().get_node("Spider_LegF3").get_node("Base")
	var leg4Base = get_parent().get_node("Spider_LegF4").get_node("Base")
